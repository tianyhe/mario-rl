...
class MetricLogger:
    ...
    def __init__(self, save_dir):
        ...
        # Metric plots
        self.plots = {
            "ep_rewards": self.save_dir / "reward_plot.png",
            "ep_lengths": self.save_dir / "length_plot.png",
            "ep_avg_losses": self.save_dir / "loss_plot.png",
            "ep_avg_qs": self.save_dir / "q_plot.png",
        }
